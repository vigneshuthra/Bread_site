...
const Clients = () => {
  ...
  return (
    <section id="testimonials" className='w-full flex flex-col justify-center items-center gap-20 bg-cover h-fit py-20 lg:px-20 px-10' style={{ backgroundImage: `url('/banner1.jpg)` }}>
      <h1 data-aos="zoom-in" data-aos-delay="200" className='text-[55px] text-black font-semibold text-center'>
      ...
      <div data-aos="zoom-in" data-aos-delay="200" className='w-full grid lg:grid-cols-4 grid-cols-1 justify-center items-center lg:gap-8 gap-20'>
        {
          clients.map((item, index) => (
            <div key={index} className='flex flex-col justify-center items-start gap-4 bg-orange-600 p-10 h-[350px] rounded-xl relative'>
              <div className='bg-white p-6 rounded-full text-orange-600 absolute -top-10'>
